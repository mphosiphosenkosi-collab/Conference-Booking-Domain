...
namespace BookingSystem.Domain.Entities
{
    ...
    {
        // ====================================================================
        // 📌 PROPERTIES - What a Room IS
        // ====================================================================

        /// <summary>
        /// 🎓 Primary Key - Unique identifier for this room
        /// 
        /// ⚠️ NOTE: Capital "ID" (not "Id" like in Booking)
        ...
        /// <summary>
        /// 🎓 Room identifier for users (e.g., "A101", "Conference Hall A")
        ...
        /// <summary>
        /// 🎓 📌 ASSIGNMENT 3.2 - Physical location of the room
        /// Example: "Floor 1, Building A", "Cape Town Office", "North Wing"
        /// 
        /// ⚠️ NOTE: lowercase 'l' - consistency issue with other properties
        ...
        // ====================================================================
        // 📌 CONSTRUCTORS - How a Room is CREATED
        // ====================================================================
        ...
        /// <summary>
        /// 📌 Business constructor - Creates a new conference room
        /// 
        ...
        /// 
        /// 📌 ISSUES TO FIX:
        /// 1. ❌ Using Exception (too generic) - use specific exceptions
        /// 2. ❌ Hardcoded capacity range (10-20) - maybe too restrictive?
        /// 3. ❌ Setting ID manually - should be auto-generated by DB
        /// 4. ❌ location default "Not found" - better to require or use null
        /// 5. ❌ No validation for RoomNumber format
        /// 
        /// 🎓 BETTER VERSION:
        ...
        public ConferenceRoom(int id, string roomNumber, int capacity, RoomType type)
        {
            ...
            if (string.IsNullOrWhiteSpace(roomNumber))
            {
                ...
                // ❌ Exception too generic - use ArgumentException
            }
            
            // 🎓 Business rule: Capacity must be between 10 and 20
            // ⚠️ This might be too restrictive for real conference rooms!
            ...
            // ⚠️ Setting ID manually - database should generate this!
            ...
            // 🎓 Default values for new rooms
            location = "Not found";  // ❌ Better to require location
            IsActive = true;          // ✅ New rooms are active by default
        }

        // ====================================================================
        // 📌 MISSING BEHAVIORS - What a Room CAN DO
        // ====================================================================
...
/// <summary>
/// 🎓 EDUCATIONAL SUMMARY - CONFERENCE ROOM ENTITY:
/// 
/// 📌 WHAT'S GOOD:
/// ✅ Has all required properties for assignments
/// ✅ IsActive for soft delete (Assignment 3.4)
/// ✅ location field (Assignment 3.2)
/// ✅ Basic validation in constructor
/// 
/// 📌 WHAT NEEDS IMPROVEMENT:
/// 
/// 1️⃣ NAMING CONSISTENCY:
