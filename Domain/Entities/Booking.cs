...
{
    /// <summary>
    /// 📌 ASSIGNMENT 2.4, 3.1, 3.2, 3.4 - Booking Domain Entity
    /// 
    ...
    /// ┌─────────────────┬─────────────────────────────┐
    /// │ Entity (Booking)│ DTO (BookingListItemDto)    │
    /// ├─────────────────┼─────────────────────────────┤
    ...
    {
        // ====================================================================
        // 📌 PROPERTIES - What a Booking IS
        // ====================================================================

        /// <summary>
        /// 🎓 Foreign Key to ConferenceRoom
        /// This establishes the database relationship
        /// 📌 ASSIGNMENT 3.4 - Data Integrity: Foreign key ensures room exists
        /// </summary>
        public int RoomId { get; set; }  

        /// <summary>
        /// 🎓 Navigation Property to ConferenceRoom
        ...
        /// <summary>
        /// 🎓 Primary Key - Unique identifier for this booking
        ...
        /// <summary>
        /// 🎓 Current status of the booking (enum)
        /// 📌 ASSIGNMENT 3.2 - Status field added
        /// Values:
        ...
        /// <summary>
        /// 🎓 📌 ASSIGNMENT 3.2 - Timestamp when booking was created
        /// Used for:
        /// - Audit trails
        ...
        /// <summary>
        /// 🎓 📌 ASSIGNMENT 3.2 - Timestamp when booking was cancelled (nullable)
        ...
        // ====================================================================
        // 📌 CONSTRUCTORS - How a Booking is CREATED
        // ====================================================================
        ...
        /// <summary>
        /// 🎓 Business constructor - Creates a new booking
        /// 
        /// 📌 ISSUES TO FIX:
        /// 1. ❌ No validation (should check room not null, start < end)
        /// 2. ❌ Doesn't set RoomId (foreign key)
        /// 3. ❌ Status should default to Pending (currently defaults to 0 anyway)
        /// 
        /// 🎓 BETTER VERSION:
        ...
        public Booking(ConferenceRoom room, DateTime start, DateTime end)
        {
            ...
            StartTime = start;
            EndTime = end;
            // ⚠️ RoomId not set! EF might not save relationship correctly
            // ⚠️ No validation!
            // ⚠️ Status defaults to 0 (Pending) automatically
        }

        // ====================================================================
        // 📌 BEHAVIORS - What a Booking CAN DO
        // ====================================================================
        ...
        /// 
        /// 📌 ASSIGNMENT 3.2 - Sets CancelledAt timestamp
        /// </summary>
        public Booking Cancel()
        {
            // ⚠️ Should check if already cancelled or completed!
            // if (Status == BookingStatus.Completed)
            //     throw new InvalidOperationException("Cannot cancel completed booking");
            
            Status = BookingStatus.Cancelled;
            CancelledAt = DateTime.UtcNow;  // ✅ Record cancellation time
            return this;
        }
    }
}
